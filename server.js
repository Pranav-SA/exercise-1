...
app.get('/api', (req, res) => {
  ...
  res.json({
    ...
    endpoints: [
      ...
      {method: 'PUT', path: '/api/books/:id', description: 'Update present book information'},
...
app.post('/api/books/', (req, res) => {
  ...
  db.books.create(newBook, function (err, ret) {
...
app.put('/api/books/:id', (req, res) => {
   ...
   */
  db.books.findByIdAndUpdate(bookId, bookNewData, function (err, retBooks) {
    if (err) throw err;
    /*
     * return the object as array of json values
     */
...
app.delete('/api/books/:id', (req, res) => {
   ...
   */
  db.books.findByIdAndRemove(bookId, function (err, retBooks) {
    if (err) throw err;
    /*
     * return the object as array of json values
     */
